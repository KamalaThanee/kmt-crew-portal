...
const CV_DASHBOARD_ROLES = [...ADMIN_ROLES, 'radio operator']
...
export function canManageCvDashboard(value: unknown) {
  return CV_DASHBOARD_ROLES.includes(normalizeRole(value))
}

export { ADMIN_ROLES, SHIP_CERTIFICATE_VIEWER_ROLES, SMS_LIBRARY_MANAGER_ROLES, MONTHLY_REPORT_MANAGER_ROLES, CV_DASHBOARD_ROLES }
