...
import { 
  ...
  Bot, CalendarRange, RefreshCw, X, Save, Trash2
} from 'lucide-react'
...
function SettingsContent() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans pb-32 pt-6 md:pt-24 px-4 md:px-12 uppercase font-bold text-[10px]">
      <div className="max-w-[1600px] mx-auto">
        <div className="mb-10 flex justify-between items-center">
          ...
          <div className="flex flex-wrap items-center justify-end gap-3">
            <button onClick={() => router.push('/admin/monthly-reports')} className="flex items-center gap-2 rounded-2xl border border-blue-500/20 bg-blue-500/10 px-5 py-4 text-blue-400 hover:bg-blue-600 hover:text-white transition-all shadow-xl"><CalendarRange size={20}/><span>Monthly Reports</span></button>
