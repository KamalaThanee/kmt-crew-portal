    ...
    <div className="p-4 md:p-12 max-w-[1600px] mx-auto pb-32 pt-28 font-sans text-white uppercase font-bold text-[10px]">
      <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap gap-3">
           ...
           <button onClick={() => { setRestockView('history'); setIsRestockModalOpen(true); }} className="px-8 py-4 bg-violet-600/10 border border-violet-500/30 text-violet-400 rounded-[20px] font-black text-xs flex items-center gap-3 transition-all active:scale-95 shadow-lg shadow-violet-500/5"><Clock size={18}/> History</button>
